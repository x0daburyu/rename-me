...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		$sql = mysqli_query($koneksi, "SELECT * FROM tapel ORDER BY tapel ASC");
		echo '<h2>Konfigurasi Tahun Pelajaran</h2><hr>';
      	echo '<div class="row">';
		echo '<div class="col-md-6"><table class="table table-bordered">';
		echo '<tr class="info"><th width="40">#</th><th width="250">Tahun Pelajaran</th>';
		echo '<th width="150"><a href="./admin.php?hlm=master&sub=tapel&aksi=baru" class="btn btn-success btn-xs">Tambah Data</a></th></tr>';
